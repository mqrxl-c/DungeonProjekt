...
3. Wenn der Spieler sich für einen Kampf entscheidet, passiert Folgendes:
   1. Angriff des Monsters: Der Spieler erhält automatisch Schaden in
    Höhe der Stärke des Monsters.
   2. Angriff des Spielers: Das Monster erhält Schaden in Höhe der Stärke des Spielers.
   3. Falls das Monster geschlagen wurde (health <= 0), ist der Kampf gewonnen und der Spieler kann den nächsten Raum 
       betreten.
   4. Falls das Monster noch lebt, muss so lange weitergekämpft werden, bis entweder der Spieler oder das Monster 
       geschlagen ist.
   5. Für den Fall, dass der Spieler das Monster besiegt, erhält er Lebenspunkte in Höhe der Hälfte des vom Monsters
...
4. Ist der letzte Raum erfolgreich durchlaufen (entweder Monster besiegt, oder erfolgreich geflohen), wird eine 
